...
import CaptionResults from '../../src/components/CaptionResults';
...
describe('CaptionResults', () => {
  ...
  describe('Accessibility', () => {
    ...
    it('should have proper ARIA labels for copy buttons', () => {
      ...
      const copyButtons = screen.getAllByLabelText(/Copy caption \d+ to clipboard/);
      expect(copyButtons).toHaveLength(mockCaptions.length);
    });
    ...
    it('should have proper ARIA label for download button', () => {
      ...
      expect(screen.getByLabelText('Download all captions as text file')).toBeInTheDocument();
    });
